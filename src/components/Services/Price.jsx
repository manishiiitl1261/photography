...
const Price = () => {
    ...
    return (
        <div className="overflow-hidden  gap-4 sm:gap-8 items-center my-4 sm:my-8">
            <div className=" text-center sm:text-4xl lg:text-6xl text-4xl italic text-black"> Pricing Plan </div>
                ...
                {cardData.map((card, index) => (
                    ...
                    >
                        <div className="bg-white rounded-lg shadow-lg p-6">
                            <h2 className="text-2xl font-bold mb-4 text-black">{card.title}</h2>
                            <p className="text-3xl font-bold mb-4 text-black">{card.price}</p>
                            <ul className="mb-4">
