      ...
      <div className="flex flex-col gap-y-5 p-4 bg-slate-700 text-white " >
        <div className="flex md:flex-row flex-col justify-between items-center md:px-10">
          <div className=" flex flex-col my-5 sm:flex-row gap-x-2 items-center">
            <span className="font-bold inline my-3 text-white text-lg md:text-xl ">{t.footer.social}</span>
            <div>
              <SocialIcons />
            </div>
          </div>
          <div className="flex flex-row items-center">
            <h1 className="sm:text-lg md:text-xl font-bold inline text-center">{t.footer.createdBy} <span className="mx-1 text-blue-400">Manish Rawat </span></h1>
            <span
        ...
        <div className=" text-center">
          <span className="text-white sm:font-bold">{t.footer.copyright}</span>
        </div>
      </div>
    </footer>
  );
