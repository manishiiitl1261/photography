  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (
        ...
        setSubmitError(
          error.message || "An error occurred while saving the portfolio item"
        );
      }
    } finally {
          ...
          {!loading && portfolioItems && portfolioItems.length === 0 && (
            <div className="text-center py-10 bg-white rounded-lg shadow">
              <p className="text-gray-500">
                No portfolio items found. Add your first photo to get started.
              </p>
            </div>
          )}
          ...
          <div className="bg-white rounded-lg shadow p-4 mb-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 space-y-2 sm:space-y-0">
              <h2 className="text-lg font-medium text-gray-900">
                Portfolio Items ({filteredAndSortedItems.length} of{" "}
              ...
              <div className="flex space-x-2">
                ...
                <select
                  ...
                  className="text-sm border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-black"
                >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        {optimizationOptions.quality === "high" &&
                          "Best quality, larger file size"}
                        {optimizationOptions.quality === "medium" &&
                          "Good balance of quality and size"}
                        {optimizationOptions.quality === "low" &&
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        {optimizationOptions.resize === "none" &&
                          "Keep original dimensions"}
                        {optimizationOptions.resize === "large" &&
                          "Ideal for hero images"}
                        {optimizationOptions.resize === "medium" &&
                          "Ideal for portfolio display"}
                        {optimizationOptions.resize === "small" &&
