    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gray-50 mt-10 border-t border-gray-200">
        <details className="cursor-pointer">
          <summary className="text-indigo-600 font-semibold text-sm mb-4">
            Debugging Tools
          </summary>
            ...
            <div className="space-y-4">
                ...
                onClick={async () => {
                  if (window.confirm("Create a test booking?")) {
                    try {
                      ...
                      if (response.ok) {
                        setMessage({
                          text: "Test booking created successfully!",
                          type: "success",
                        });
                        ...
                        setMessage({
                          text: `Failed to create test booking: ${data.message}`,
                          type: "error",
                        });
                      }
                    } catch (error) {
              ...
              <button
                onClick={() => {
                  ...
                  setMessage({
                    text: "Check console for debug info",
                    type: "info",
                  });
                }}
                ...
                <button
                  onClick={async () => {
                    try {
                      ...
                      if (data.success && data.isAdmin) {
                        setMessage({
                          text: "Your account has admin privileges.",
                          type: "success",
                        });
                      } else {
                        setMessage({
                ...
                <div className="mt-4">
                  <button
                    onClick={async () => {
                      try {
                        setMessage({
                          text: "Direct API call in progress...",
                          type: "info",
                        });
                        ...
                        console.log(
                          "Making direct API call to:",
                          `${apiUrl}/api/bookings/admin/all`
                        );
                        console.log(
                          "With token:",
                        ...
                        try {
                          ...
                          if (data.success) {
                            ...
                            setMessage({
                              text: `API returned success: false - ${
                    ...
                    <div className="mt-4 space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            ₹{detailsOpen.price.toLocaleString()}
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {formatDateTime(detailsOpen.createdAt)}
                          </p>
                        </div>
                  ...
                  <div className="flex space-x-2">
                    {detailsOpen.status !== "approved" && (
                      <button
                        ...
                        onClick={() =>
                          handleStatusChange(detailsOpen._id, "approved")
                        }
                    ...
                    {detailsOpen.status !== "rejected" && (
                      <button
                        ...
                        onClick={() =>
                          handleStatusChange(detailsOpen._id, "rejected")
                        }
                        disabled={submitLoading}
                      >
                    ...
                    {detailsOpen.status !== "completed" &&
                      detailsOpen.status === "approved" && (
                        <button
                          type="button"
                          className="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                          onClick={() =>
                            handleStatusChange(detailsOpen._id, "completed")
                          }
                          disabled={submitLoading}
                        >
