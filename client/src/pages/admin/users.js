          ...
          <div className="mb-6 flex flex-col sm:flex-row justify-between gap-4">
            <form onSubmit={handleSearch} className="flex w-full sm:w-auto">
              <input
                ...
                className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:w-64 sm:text-sm border-gray-300 rounded-md text-black"
              />
              <button
                type="submit"
            ...
            <div className="flex gap-2">
              <select
                ...
                className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:w-auto sm:text-sm border-gray-300 rounded-md text-black"
              >
